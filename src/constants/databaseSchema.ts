...
export const DATABASE_SCHEMA: DatabaseTable[] = [
  ...
  },
  {
    name: 'cases',
    displayName: 'Cases',
    description: 'Main case information',
    category: 'Cases',
    fields: [
      {
        table: 'cases',
      ...
      {
        table: 'cases',
        field: 'settlement_approval_date',
        type: 'date',
        required: false,
        description: 'Settlement approval date',
        category: 'Dates',
      },
      {
        table: 'cases',
        field: 'distribution_start_date',
        type: 'date',
        required: false,
      ...
      {
        table: 'cases',
        field: 'final_approval_hearing',
        type: 'date',
        required: false,
        description: 'Final approval hearing date',
        category: 'Dates',
      },
      {
        table: 'cases',
        field: 'case_closure_date',
        type: 'date',
        required: false,
...

  {
    ...
    fields: [
      ...
      },
      {
        ...
        category: 'Phone Details',
        maxLength: 20,
      },
      {
        table: 'communications',
        field: 'call_duration_minutes',
        type: 'number',
        required: false,
      ...
      },
      {
        ...
        required: false,
        description: 'Email address',
        category: 'Email Details',
        maxLength: 255,
      },
      {
        table: 'communications',
        field: 'email_template_used',
        type: 'text',
        required: false,
...

  {
    ...
    fields: [
      ...
      },
      {
        ...
        enumValues: ['admin', 'case_manager', 'attorney', 'clerk', 'viewer'],
      },
      {
        table: 'users',
        field: 'department',
...

  {
    ...
    description: 'Case type definitions',
    category: 'Reference',
    fields: [
      {
        table: 'case_types',
      ...
      {
        table: 'case_types',
        field: 'typical_duration_months',
        type: 'number',
        required: false,
        description: 'Typical duration in months',
        category: 'Case Type Info',
      },
      {
        table: 'case_types',
        field: 'requires_court_approval',
        type: 'boolean',
        required: false,
        description: 'Requires court approval',
        category: 'Case Type Info',
      },
      {
        table: 'case_types',
        ...
        type: 'boolean',
        required: false,
        description: 'Case type active status',
        category: 'Status',
      },
    ],
  },

  {
    ...
    description: 'Document type definitions',
    category: 'Reference',
    fields: [
      {
      ...
      },
      {
        ...
        type: 'boolean',
        required: false,
        description: 'Document type active status',
        category: 'Status',
      },
    ],
  },

  {
    name: 'notes',
    displayName: 'Notes',
    description: 'Notes system for all entities',
    category: 'Notes',
    fields: [
      {
        table: 'notes',
        ...
        category: 'Note Info',
        enumValues: ['case', 'party', 'document', 'communication', 'payment'],
      },
      {
        table: 'notes',
        field: 'entity_id',
